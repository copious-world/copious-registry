...
//
// This class sets up a direcotry watcher for a configured directory. When it the directoy gets a new file, 
        ...
        if ( data.length > 1 &&  (this._el_manager != false) ) {
            try {
                ...
                if ( Array.isArray(f_obj) ) {
                    if ( this._el_manager ) {
                        let tracking = f_obj.shift()  // here is a conventions... this is an id for the group...
                        let new_tracks = []
