...
class DirWatcherHandler {
    ...
    constructor(directory,element_manager,conf) {
        ...
        this._tracking_list_map = {}        // if the file is an array of meta objects, then map a single tracking number for the file to a list of all individual tracks in the file
