...
class ObjFileDirLoader {
    ...
    constructor(dirpath,list_ref,after_loaded_action,conf) {
        this._dir = constructor
        this.dir_fos = new DirectoryCache({
            "default_firectory" : dirpath,
    ...
    set noisy(what) {
        this.dir_fos._noisy = what
    }

    get noisy() {
        return this.dir_fos._noisy
    }

    set crash_cant_load(what) {
        this.dir_fos._crash_cant_load = what
    }

    get crash_cant_load() {
        return this.dir_fos._crash_cant_load
    }
    ...
    async load_directory() {
        await this.dir_fos.load_directory('',this._dir,this.item_injector,this._after_action)
    }
    ...
    async backup_to_directory() {
        ...
        await this.dir_fos.backup_to_directory(this._dir,file_namer,this._list)
    }
